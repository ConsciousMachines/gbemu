...
u8 Emulator::rb(uint16_t addr, bool add_cycles)
{
    ...
    case 0x8000:
    case 0x9000: ret = mem_vram[addr & 0x1FFF]; break; // Graphics: VRAM (8k)
    case 0xA000:
    ...
    case 0xF000:
        ...
        case 0xE00: // Graphics: object attribute memory
            if (addr < 0xFEA0) ret = mem_oam[addr & 0xFF];
            else ret = 0x00; // OAM is 160 bytes, remaining bytes read as 0
            break;
        case 0xF00:
    ...
    case 0xF000:
        ...
        case 0xF00:
            if (addr <= 0xFF7F) // I/O registers
            {
                ...
                case 0xFF44: reg_FF44_lineY = data; break;// Current scanline, should not happen!
